    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            //new PageBean() { title = "Scenario 3 - Tabs", type = typeof(Page3) }
              ...
              new PageBean("Scenario 1 - Basic",typeof(Page1) ),
              new PageBean("Scenario 2 - Headers",typeof(Page2)),
              new PageBean("Scenario 3 - Tabs",typeof(Page3))
        };
        ...
        {
            splitview1.IsPaneOpen = (splitview1.IsPaneOpen == true) ? false : true;
        }
    }
}
